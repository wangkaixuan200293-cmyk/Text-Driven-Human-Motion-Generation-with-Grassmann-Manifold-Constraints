...
def calculate_mpjpe(gt_joints, pred_joints):
    """
    gt_joints: num_poses x joints_num(22) x 3
    pred_joints: num_poses x joints_num(22) x 3
    ...
    # Compute MPJPE
    mpjpe = torch.linalg.norm(pred_joints - gt_joints, dim=-1) # num_poses x joints_num=22
